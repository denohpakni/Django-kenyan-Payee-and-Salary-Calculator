// Will need to create a last function for NetPay taking all other functions as arguments
//Net pay is the remaining amount of an employee's gross pay after deductions, such as taxes and retirement contributions, are made.
function net_pay(basic_pay, benefits, insurance){
    

    var basic_pay = document.getElementById("gross_salary"); //"Please enter basic/gross pay: "
    var benefits = document.getElementById("benefits"); //"Please enter housing allowance: "
    var insurance = document.getElementById("insurance");  //"Amount of insurance premiums paid by the company: "

    // Insurance relief is equivalent to 15%
    // taxable pay is equal to (basic pay + allowance) - (15% of insurance premiums)
    var gross_pay = basic_pay + benefits;
    ...
    return peanuts = gross_pay - total_deductions;
    
    //show the reults on the results.html page
    document.getElementById("yournet").innerHTML="You take home peanust are: " + peanuts.toFixed() + " $";
    document.getElementById("payee").innerHTML="PAYE deducted by Govt: " + govtpayee.toFixed() + " $";
    document.getElementById("NHIF").innerHTML="NHIF contribution: " + nhif_deductions.toFixed() + " $";
    document.getElementById("NSSF").innerHTML="NSSF contribution: " + nssf.toFixed() + " $";
